...
import type { CssSyntaxError } from "@/model/tokens/design-tokens";
import type { PersistenceStatus } from "@/routes/workspace/components/workspace-header";
import { CODE_EDITOR_THEME_OPTIONS, type CodeEditorTheme } from "@/routes/workspace/components/code-editor";
import styles from "@/routes/workspace/styles.module.css";

const CodeEditor = dynamic(
  () => import("@/routes/workspace/components/code-editor").then((module) => module.CodeEditor),
  {
    ssr: false,
